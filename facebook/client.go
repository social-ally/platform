...
// ClientOption configures a Facebook client.
type ClientOption func(*FacebookClient) error
...
func NewFacebookClient(clientID, clientSecret, redirectURL string, options ...ClientOption) (*FacebookClient, error) {
	if clientID == "" {
