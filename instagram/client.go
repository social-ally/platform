...
var (
	ErrNilHTTPClient    = errors.New("Instagram HTTP client is nil")
	ErrNilRequest       = errors.New("Instagram request is nil")
...
// APIError describes a non-success response from the Instagram API.
